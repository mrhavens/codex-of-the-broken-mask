...
The  directory hosts a public-facing, SEO-optimized canonical declaration for the `codex-of-the-broken-mask` repository, designed for GitHub Pages compatibility and enhanced discoverability.
...
This directory ensures the `codex-of-the-broken-mask` project is discoverable via search engines and accessible to humans and bots. It declares the canonical repository at [https://remember.thefoldwithin.earth/mrhavens/codex-of-the-broken-mask](https://remember.thefoldwithin.earth/mrhavens/codex-of-the-broken-mask) and links to all mirrors, reinforcing the GitField recursive metadata strategy for sovereign publishing.

Generated by `gitfield-sync` at 2025-06-20T19:33:09Z (v1.5).
